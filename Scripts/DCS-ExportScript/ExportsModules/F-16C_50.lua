...
[363]=  "%.1f",   --  ( SpeedBrake_Indicator) 
    ...
    -- ECM
[102]=  "%.1f",   --  ( ECM_Light)
[462]=  "%.1f",   --  ( ECM_Button_Lights.Btn_1_A)
[463]=  "%.1f",   --  (  ECM_Button_Lights.Btn_1_F)
[464]=  "%.1f",   --  (  ECM_Button_Lights.Btn_1_T)
[466]=  "%.1f",   --  (  ECM_Button_Lights.Btn_2_S)
[467]=  "%.1f",   --  (  ECM_Button_Lights.Btn_2_A)
[468]=  "%.1f",   --  (  ECM_Button_Lights.Btn_2_F)
[469]=  "%.1f",   --  (  ECM_Button_Lights.Btn_2_T)
[471]=  "%.1f",   --  (  ECM_Button_Lights.Btn_3_S)
[472]=  "%.1f",   --  (  ECM_Button_Lights.Btn_3_A)
[473]=  "%.1f",   --  (  ECM_Button_Lights.Btn_3_F)
[474]=  "%.1f",   --  (  ECM_Button_Lights.Btn_3_T)
[476]=  "%.1f",   --  (  ECM_Button_Lights.Btn_4_S)
[477]=  "%.1f",   --  (  ECM_Button_Lights.Btn_4_A)
[478]=  "%.1f",   --  (  ECM_Button_Lights.Btn_4_F)
[479]=  "%.1f",   --  (  ECM_Button_Lights.Btn_4_T)
[481]=  "%.1f",   --  (  ECM_Button_Lights.Btn_5_S)
[482]=  "%.1f",   --  (  ECM_Button_Lights.Btn_5_A)
[483]=  "%.1f",   --  (  ECM_Button_Lights.Btn_5_F)
[484]=  "%.1f",   --  (  ECM_Button_Lights.Btn_5_T)
[486]=  "%.1f",   --  (  ECM_Button_Lights.Btn_6_S)
[487]=  "%.1f",   --  (  ECM_Button_Lights.Btn_6_A)
[488]=  "%.1f",   --  (  ECM_Button_Lights.Btn_6_F)
[489]=  "%.1f",   --  (  ECM_Button_Lights.Btn_6_T)
[491]=  "%.1f",   --  (  ECM_Button_Lights.Btn_FRM_S)
[492]=  "%.1f",   --  (  ECM_Button_Lights.Btn_FRM_A)
[493]=  "%.1f",   --  (  ECM_Button_Lights.Btn_FRM_F)
[494]=  "%.1f",   --  (  ECM_Button_Lights.Btn_FRM_T)
[496]=  "%.1f",   --  (  ECM_Button_Lights.Btn_SPL_S)
[497]=  "%.1f",   --  (  ECM_Button_Lights.Btn_SPL_A)
[498]=  "%.1f",   --  (  ECM_Button_Lights.Btn_SPL_F)
[499]=  "%.1f",   --  (  ECM_Button_Lights.Btn_SPL_T)
}
...
[415]  = "%.2f",   --PTR-ANARC164-0.025MHZ-SEL-415, UHF Manual Frequency Knob 0.025 MHz, UHF Manual Frequency Knob 0.025 MHz, , , (-0.25, 0, 0.75)
  -- ECM
[455]=  "%1d",   --  (  ECM_Button.Pwr)
[456]=  "%.2f",   --  (  ECM_Button.Dim)
[457]=  "%1d",   --  (  ECM_Button.Xmit)
[458]=  "%1d",   --  (  ECM_Button.Reset)
[459]=  "%1d",   --  (  ECM_Button.BIT)
[460]=  "%1d",   --  (  ECM_Button.Btn_1)
[465]=  "%1d",   --  (  ECM_Button.Btn_2)
[470]=  "%1d",   --  (  ECM_Button.Btn_3)
[475]=  "%1d",   --  (  ECM_Button.Btn_4)
[480]=  "%1d",   --  (  ECM_Button.Btn_5)
[485]=  "%1d",   --  (  ECM_Button.Btn_6)
[490]=  "%1d",   --  (  ECM_Button.Btn_FRM)
[495]=  "%1d",   --  (  ECM_Button.Btn_SPL)
}
...
function ExportScript.ProcessIkarusDCSConfigHighImportance(mainPanelDevice)
	...
	if mainPanelDevice:get_argument_value(461) > 0 then
		lECMbtn1S = "S"
	end
	if mainPanelDevice:get_argument_value(462) > 0 then
	   lECMbtn1A = "A"
	end
	if mainPanelDevice:get_argument_value(463) > 0 then
		lECMbtn1F = "F"
	end
	if mainPanelDevice:get_argument_value(464) > 0 then
		lECMbtn1T = "T"
	end
	...
	local lECMbtn2F =  "  "
	local lECMbtn2T =  "  "
	if mainPanelDevice:get_argument_value(466) > 0 then
		lECMbtn2S = "S"
	end
	if mainPanelDevice:get_argument_value(467) > 0 then
	   lECMbtn2A = "A"
	end
	if mainPanelDevice:get_argument_value(468) > 0 then
		lECMbtn2F = "F"
	end
	if mainPanelDevice:get_argument_value(469) > 0 then
		lECMbtn2T = "T"
	end
	...
	local lECMbtn3F =  "  "
	local lECMbtn3T =  "  "
	if mainPanelDevice:get_argument_value(471) > 0 then
		lECMbtn3S = "S"
	end
	if mainPanelDevice:get_argument_value(472) > 0 then
	   lECMbtn3A = "A"
	end
	if mainPanelDevice:get_argument_value(473) > 0 then
		lECMbtn3F = "F"
	end
	if mainPanelDevice:get_argument_value(474) > 0 then
		lECMbtn3T = "T"
	end
	...
	local lECMbtn4F =  "  "
	local lECMbtn4T =  "  "
	if mainPanelDevice:get_argument_value(476) > 0 then
		lECMbtn4S = "S"
	end
	if mainPanelDevice:get_argument_value(477) > 0 then
	   lECMbtn4A = "A"
	end
	if mainPanelDevice:get_argument_value(478) > 0 then
		lECMbtn4F = "F"
	end
	if mainPanelDevice:get_argument_value(479) > 0 then
		lECMbtn4T = "T"
	end
	...
	local lECMbtn5F =  "  "
	local lECMbtn5T =  "  "
	if mainPanelDevice:get_argument_value(481) > 0 then
		lECMbtn5S = "S"
	end
	if mainPanelDevice:get_argument_value(482) > 0 then
	   lECMbtn5A = "A"
	end
	if mainPanelDevice:get_argument_value(483) > 0 then
		lECMbtn5F = "F"
	end
	if mainPanelDevice:get_argument_value(484) > 0 then
		lECMbtn5T = "T"
	end
	...
	local lECMbtn6F =  "  "
	local lECMbtn6T =  "  "
	if mainPanelDevice:get_argument_value(486) > 0 then
		lECMbtn6S = "S"
	end
	if mainPanelDevice:get_argument_value(487) > 0 then
	   lECMbtn6A = "A"
	end
	if mainPanelDevice:get_argument_value(488) > 0 then
		lECMbtn6F = "F"
	end
	if mainPanelDevice:get_argument_value(489) > 0 then
		lECMbtn6T = "T"
	end
	...
	local lECMbtnFRMF =  "  "
	local lECMbtnFRMT =  "  "
	if mainPanelDevice:get_argument_value(491) > 0 then
		lECMbtnFRMS = "S"
	end
	if mainPanelDevice:get_argument_value(492) > 0 then
	   lECMbtnFRMA = "A"
	end
	if mainPanelDevice:get_argument_value(493) > 0 then
		lECMbtnFRMF = "F"
	end
	if mainPanelDevice:get_argument_value(494) > 0 then
		lECMbtnFRMT = "T"
	end
	...
	local lECMbtnSPLF =  "  "
	local lECMbtnSPLT =  "  "
	if mainPanelDevice:get_argument_value(496) > 0 then
		lECMbtnSPLS = "S"
	end
	if mainPanelDevice:get_argument_value(497) > 0 then
	   lECMbtnSPLA = "A"
	end
	if mainPanelDevice:get_argument_value(498) > 0 then
		lECMbtnSPLF = "F"
	end
	if mainPanelDevice:get_argument_value(499) > 0 then
		lECMbtnSPLT = "T"
	end


	ExportScript.Tools.SendData(2000, string.format("%s     %s\n\n%s     %s", lECMbtn1S, lECMbtn1A, lECMbtn1F, lECMbtn1T))
	ExportScript.Tools.SendData(2001, string.format("%s     %s\n\n%s     %s", lECMbtn2S, lECMbtn2A, lECMbtn2F, lECMbtn2T))
	ExportScript.Tools.SendData(2002, string.format("%s     %s\n\n%s     %s", lECMbtn3S, lECMbtn3A, lECMbtn3F, lECMbtn3T))
	ExportScript.Tools.SendData(2003, string.format("%s     %s\n\n%s     %s", lECMbtn4S, lECMbtn4A, lECMbtn4F, lECMbtn4T))
	ExportScript.Tools.SendData(2004, string.format("%s     %s\n\n%s     %s", lECMbtn5S, lECMbtn5A, lECMbtn5F, lECMbtn5T))
	ExportScript.Tools.SendData(2005, string.format("%s     %s\n\n%s     %s", lECMbtn6S, lECMbtn6A, lECMbtn6F, lECMbtn6T))
	ExportScript.Tools.SendData(2006, string.format("%s     %s\n\n%s     %s", lECMbtnFRMS, lECMbtnFRMA, lECMbtnFRMF, lECMbtnFRMT))
	ExportScript.Tools.SendData(2007, string.format("%s     %s\n\n%s     %s", lECMbtnSPLS, lECMbtnSPLA, lECMbtnSPLF, lECMbtnSPLT))
end
