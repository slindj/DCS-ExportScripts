...
ExportScript.ConfigArguments =
{
	...
	[1] = "%1d", --Cockpit.CH47.OCFC.LH_AUX_FWD_PUMP_SW
	[2] = "%1d", --Cockpit.CH47.OCFC.LH_MAIN_FWD_PUMP_SW
	[3] = "%1d", --Cockpit.CH47.OCFC.LH_MAIN_AFT_PUMP_SW
	[4] = "%1d", --Cockpit.CH47.OCFC.LH_AUX_AFT_PUMP_SW
	[5] = "%1d", --Cockpit.CH47.OCFC.RH_AUX_FWD_PUMP_SW
	[6] = "%1d", --Cockpit.CH47.OCFC.RH_MAIN_FWD_PUMP_SW
	[7] = "%1d", --Cockpit.CH47.OCFC.RH_MAIN_AFT_PUMP_SW
	[8] = "%1d", --Cockpit.CH47.OCFC.RH_AUX_AFT_PUMP_SW
	[9] = "%1d", --Cockpit.CH47.OCFC.REFUEL_STA_SW
	[10] = "%1d", --Cockpit.CH47.OCFC.XFEED_SW
	[493] = "%.2f", --Cockpit.CH47.OCHC.FLT_CONTR_SW
	[494] = "%1d", --Cockpit.CH47.OCHC.PTU_1_SW
	[495] = "%1d", --Cockpit.CH47.OCHC.PTU_2_SW
	[496] = "%1d", --Cockpit.CH47.OCHC.PWR_STEER_COVER
	[497] = "%1d", --Cockpit.CH47.OCHC.PWR_STEER_SW
	[498] = "%.2f", --Cockpit.CH47.OCHC.RAMP_SW
	[499] = "%1d", --Cockpit.CH47.OCHC.RAMP_EMER_COVER
	[500] = "%.2f", --Cockpit.CH47.OCHC.RAMP_EMER_SW
	[501] = "%1d", --Cockpit.CH47.OCPS.ENG1_FAN_SW
	[502] = "%1d", --Cockpit.CH47.OCPS.ENG1_DOOR_SW
	[503] = "%1d", --Cockpit.CH47.OCPS.ENG2_FAN_SW
	[504] = "%1d", --Cockpit.CH47.OCPS.ENG2_DOOR_SW
	[505] = "%1d", --Cockpit.CH47.OCLP.CONSOLE_DIMMER
	[506] = "%.2f", --Cockpit.CH47.OCLP.STICK_DIMMER
	[507] = "%1d", --Cockpit.CH47.OCLP.INST_SW
	[508] = "%1d", --Cockpit.CH47.OCLP.OVHD_SW
	[509] = "%.2f", --Cockpit.CH47.OCLP.EMER_SW
	[510] = "%.2f", --Cockpit.CH47.OCLP.DOME_SW
	[511] = "%.2f", --Cockpit.CH47.OCLP.FLOOD_DIMMER
	[512] = "%.2f", --Cockpit.CH47.OCLP.ANTICOL_KB
	[513] = "%.2f", --Cockpit.CH47.OCLP.IR_PATTERN_KB
	[514] = "%.2f", --Cockpit.CH47.OCLP.IR_DIMMER
	[515] = "%.2f", --Cockpit.CH47.OCLP.FORM_SW
	[516] = "%.2f", --Cockpit.CH47.OCLP.FORM_MODE_SW
	[517] = "%.2f", --Cockpit.CH47.OCLP.FORM_DIMMER
	[518] = "%.2f", --Cockpit.CH47.OCLP.POSN_SW
	[519] = "%1d", --Cockpit.CH47.OCLP.POSN_MODE_SW
	[520] = "%1d", --Cockpit.CH47.OCLP.PLT_SRCHLT_SW
	[521] = "%.2f", --Cockpit.CH47.OCLP.PLT_SRCHLT_SW
	[522] = "%.2f", --Cockpit.CH47.OCLP.CTR_DIMMER
	[523] = "%.2f", --Cockpit.CH47.OCLP.PLT_DIMMER
	[524] = "%1d", --Cockpit.CH47.OCLP.CPLT_SRCHLT_SW
	[525] = "%.2f", --Cockpit.CH47.OCLP.CPLT_DIMMER
	[526] = "%.2f", --Cockpit.CH47.OCLP.OVHD_DIMMER
	[527] = "%1d", --Cockpit.CH47.OCAI.CPLT_SW
	[528] = "%1d", --Cockpit.CH47.OCAI.CTR_SW
	[529] = "%1d", --Cockpit.CH47.OCAI.PLT_SW
	[530] = "%1d", --Cockpit.CH47.OCAI.PITOT_SW
	[534] = "%.2f", --Cockpit.CH47.OCEC_ENG1_LV
	[535] = "%.2f", --Cockpit.CH47.OCEC_ENG2_LV
	[536] = "%.2f", --Cockpit.CH47.OCEC_ENG1_LV
	[537] = "%.2f", --Cockpit.CH47.OCEC_ENG2_LV
	[541] = "%.2f", --Cockpit.CH47.OCTW.LT_SW
	[542] = "%1d", --Cockpit.CH47.OCTW.ALARM_SW
	[543] = "%.2f", --Cockpit.CH47.OCTW.HTR_RHEOSTAT
	[544] = "%.2f", --Cockpit.CH47.OCTW.HTR_MODE_SW
	[545] = "%1d", --Cockpit.CH47.OCTW.HTR_START_SW
	[546] = "%1d", --Cockpit.CH47.OCHH.CABLE_CUT_COVER
	[547] = "%1d", --Cockpit.CH47.OCHH.CABLE_CUT_SW
	[548] = "%.2f", --Cockpit.CH47.OCHH.HOIST_KB
	[549] = "%1d", --Cockpit.CH47.OCHH.HOIST_KB
	[550] = "%.2f", --Cockpit.CH47.OCHH.HOIST_KB
	
	-- Right CDU
	
	[417] = "%1d", --Cockpit.CH47.CDU.KEY_MSN
	[418] = "%1d", --Cockpit.CH47.CDU.KEY_FPLN
	[419] = "%1d", --Cockpit.CH47.CDU.KEY_FD
	[420] = "%1d", --Cockpit.CH47.CDU.KEY_IDX
	[421] = "%1d", --Cockpit.CH47.CDU.KEY_DIR
	[422] = "%1d", --Cockpit.CH47.CDU.KEY_SNSR
	[423] = "%1d", --Cockpit.CH47.CDU.KEY_MFD_DATA
	[424] = "%1d", --Cockpit.CH47.CDU.LSK_L1
	[425] = "%1d", --Cockpit.CH47.CDU.LSK_L2
	[426] = "%1d", --Cockpit.CH47.CDU.LSK_L3
	[427] = "%1d", --Cockpit.CH47.CDU.LSK_L4
	[428] = "%1d", --Cockpit.CH47.CDU.LSK_L5
	[429] = "%1d", --Cockpit.CH47.CDU.LSK_L6
	[430] = "%1d", --Cockpit.CH47.CDU.LSK_R1
	[431] = "%1d", --Cockpit.CH47.CDU.LSK_R2
	[432] = "%1d", --Cockpit.CH47.CDU.LSK_R3
	[433] = "%1d", --Cockpit.CH47.CDU.LSK_R4
	[434] = "%1d", --Cockpit.CH47.CDU.LSK_R5
	[435] = "%1d", --Cockpit.CH47.CDU.LSK_R6
	[436] = "%1d", --Cockpit.CH47.CDU.KEY_BRT
	[437] = "%1d", --Cockpit.CH47.CDU.KEY_DIM
	[438] = "%1d", --Cockpit.CH47.CDU.KEY_CNI
	[439] = "%1d", --Cockpit.CH47.CDU.KEY_PAD
	[440] = "%1d", --Cockpit.CH47.CDU.KEY_arrow_left
	[441] = "%1d", --Cockpit.CH47.CDU.KEY_arrow_right
	[442] = "%1d", --Cockpit.CH47.CDU.KEY_arrow_up
	[443] = "%1d", --Cockpit.CH47.CDU.KEY_arrow_down
	[444] = "%1d", --Cockpit.CH47.CDU.KEY_CLR
	[445] = "%1d", --Cockpit.CH47.CDU.KEY_WPN
	[446] = "%1d", --Cockpit.CH47.CDU.KEY_1
	[447] = "%1d", --Cockpit.CH47.CDU.KEY_2
	[448] = "%1d", --Cockpit.CH47.CDU.KEY_3
	[449] = "%1d", --Cockpit.CH47.CDU.KEY_4
	[450] = "%1d", --Cockpit.CH47.CDU.KEY_5
	[451] = "%1d", --Cockpit.CH47.CDU.KEY_6
	[452] = "%1d", --Cockpit.CH47.CDU.KEY_7
	[453] = "%1d", --Cockpit.CH47.CDU.KEY_8
	[454] = "%1d", --Cockpit.CH47.CDU.KEY_9
	[455] = "%1d", --Cockpit.CH47.CDU.KEY_0
	[456] = "%1d", --Cockpit.CH47.CDU.KEY_dot
	[457] = "%1d", --Cockpit.CH47.CDU.KEY_MARK
	[458] = "%1d", --Cockpit.CH47.CDU.KEY_slash
	[459] = "%1d", --Cockpit.CH47.CDU.KEY_A
	[460] = "%1d", --Cockpit.CH47.CDU.KEY_B
	[461] = "%1d", --Cockpit.CH47.CDU.KEY_C
	[462] = "%1d", --Cockpit.CH47.CDU.KEY_D
	[463] = "%1d", --Cockpit.CH47.CDU.KEY_E
	[464] = "%1d", --Cockpit.CH47.CDU.KEY_F
	[465] = "%1d", --Cockpit.CH47.CDU.KEY_G
	[466] = "%1d", --Cockpit.CH47.CDU.KEY_H
	[467] = "%1d", --Cockpit.CH47.CDU.KEY_I
	[468] = "%1d", --Cockpit.CH47.CDU.KEY_J
	[469] = "%1d", --Cockpit.CH47.CDU.KEY_K
	[470] = "%1d", --Cockpit.CH47.CDU.KEY_L
	[471] = "%1d", --Cockpit.CH47.CDU.KEY_M
	[472] = "%1d", --Cockpit.CH47.CDU.KEY_N
	[473] = "%1d", --Cockpit.CH47.CDU.KEY_O
	[474] = "%1d", --Cockpit.CH47.CDU.KEY_P
	[475] = "%1d", --Cockpit.CH47.CDU.KEY_Q
	[476] = "%1d", --Cockpit.CH47.CDU.KEY_R
	[477] = "%1d", --Cockpit.CH47.CDU.KEY_S
	[478] = "%1d", --Cockpit.CH47.CDU.KEY_T
	[479] = "%1d", --Cockpit.CH47.CDU.KEY_U
	[480] = "%1d", --Cockpit.CH47.CDU.KEY_V
	[481] = "%1d", --Cockpit.CH47.CDU.KEY_W
	[482] = "%1d", --Cockpit.CH47.CDU.KEY_X
	[483] = "%1d", --Cockpit.CH47.CDU.KEY_Y
	[484] = "%1d", --Cockpit.CH47.CDU.KEY_Z
	[485] = "%1d", --Cockpit.CH47.CDU.KEY_SP
	[486] = "%1d", --Cockpit.CH47.CDU.KEY_dash
	[487] = "%1d", --Cockpit.CH47.CDU.KEY_TDL
	[488] = "%1d", --Cockpit.CH47.CDU.KEY_ASE
	[489] = "%1d", --Cockpit.CH47.CDU.KEY_empty
	[490] = "%1d", --Cockpit.CH47.CDU.KEY_DATA
	[490] = "%1d", --Cockpit.CH47.CDU.KEY_STAT
	[985] = "%.2d", --Cockpit.CH47.MFK_OUTER_RIGHT
	[986] = "%.2d", --Cockpit.CH47.MFK_INNER_RIGHT
	[987] = "%1d", --Cockpit.CH47.MFK_INNER_RIGHT
}
