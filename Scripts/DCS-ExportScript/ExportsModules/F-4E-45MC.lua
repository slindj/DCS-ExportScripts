...
ExportScript.ConfigArguments =
{
    ...
    [131] = "%.1f",  -- Pilot_UHF_Freq_Knob_DecHundreds {-0.333333333, 0, 1, Set Frequency (decimal hundreds)}
    ...
    [156] = "%.1f",  -- RIO_UHF_Freq_Knob_DecHundreds {-0.333333333, 0, 1, Set Frequency (decimal hundreds)}
    ...
    [305] = "%.1f",  -- Bomb_Qty_Knob {-0.090919091, 0, 1, Select Quantity}
    ...
    [641] = "%.1f",  -- Pilot_TACAN_Chan_TensAndMore_Knob {-0.083333333, 0, 1, Set TACAN Channel (hundreds)}
    ...
    [648] = "%.1f",  -- Rio_TACAN_Chan_TensAndMore_Knob {-0.083333333, 0, 1, Set TACAN Channel (hundreds)}
    ...
    [662] = "%.1f",  -- PILOT_NAV_FUNCT_SEL_PANEL_BRG_DIST_SWITCH {-0.333333333, 0, 1, Select Navigation Input}
    [663] = "%.1f",  -- PILOT_NAV_FUNCT_SEL_PANEL_SOURCE_MODE_SELECTOR_KNOB {-0.333333333, 0, 1, Select Navigation Mode}
    ...
    [955] = "%.1f",  -- COMPASS_PANEL_PILOT_MODE_SELECTOR_KNOB {1, 0.666666667, 1, Set Compass Mode (hold to sync)}
    ...
    [998] = "%.1f",  -- INS_WSO_POWER_KNOB {-0.333333333, 0, 1, INS Power Knob}
    [999] = "%.1f",  -- INS_WSO_ALIGN_LIGHT
    [1000] = "%.1f", -- INS_WSO_HEAT_LIGHT
    [1001] = "%.1f", -- RADAR_WSO_METER_SELECTOR_KNOB {-0.111543333, -0.673, 1, Select Meter Mode (Volt/Signal)}
    ...
    [1322] = "%.1f", -- Pilot_IFF_Code {-0.3333, 0, 0.9999 Select Mode 4 Function}
    ...
    [1332] = "%.1f", -- Pilot_IFF_Mode_1_Units {-0.333333333, 0, 1, Set M1, code (ones)}
    ...
    [1375] = "%.1f", -- Pilot_UHF_Freq_Hundreds {-0.333333333, 0, 1, Set Frequency (hundreds)}
    ...
    [1444] = "%.1f", -- AN_ALE40_Chaff_Mode {-0.333333333, 0, 1, Select Chaff Mode}
    ...
    [1501] = "%.1f", -- Pilot_ALE40_Chaff_Interval {-0.333333333, 0, 1, Select Chaff Burst Interval}
    [1502] = "%.1f", -- Pilot_ALE40_Chaff_Count_Salvo {-0.25, 0, 1, Select Chaff Salvo Count}
    [1503] = "%.1f", -- Pilot_ALE40_Chaff_Interval_Salvo {-0.166666667, 0, 1, Select Chaff Salvo Interval}
    ...
    [2030] = "%.1f", -- RIO_UHF_Frequency_Hundreds {-0.333333333, 0, 1, Set Frequency (hundreds)}
